...
class ImportKoperasiSpreadsheet extends Command
{
    ...
    protected $description = 'Import data koperasi dari spreadsheet CSV Google Sheets atau file lokal.';

    public function handle(KoperasiService $imports): int
    {
        ...
        if (! $path) {
            ...
            $temporaryPath = tempnam(sys_get_temp_dir(), 'koperasi-').'.csv';
        ...
        $message = "Berhasil import data koperasi {$changed} data berubah";
